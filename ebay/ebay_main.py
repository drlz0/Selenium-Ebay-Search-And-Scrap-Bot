...
from ebay.ebay_filtration import EbayFiltration
from ebay.ebay_scrap import EbayScrap
...
class Ebay(webdriver.Chrome):
    ...
    def scrap_results(self):
        ...
        table.add_rows(scrap.results(n=10))  # define amount of results shown (from top to down)
        print(table)
